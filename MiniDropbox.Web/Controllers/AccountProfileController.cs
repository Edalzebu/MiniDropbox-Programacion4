    ...
    public class AccountProfileController : BootstrapBaseController
    {
        ...
        public new ActionResult Profile()
        {
            ...
            if (userData.SpaceLimit > 1024)
            {
                ...
                userData.SpaceLimit = newspace;
            }
            if (userData.UsedSpace > 1024)
            {
                var newspace = userData.UsedSpace / 1024;
                userData.UsedSpace = newspace;
            }
           
            userData = _writeOnlyRepository.Update(userData);
